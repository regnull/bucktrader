...
See [11-plotting.md](11-plotting.md) for the full plotting specification, including chart layout, `PlotScheme`, per-component `plotinfo`/`plotlines` configuration, and `cortex.plot()` invocation.
